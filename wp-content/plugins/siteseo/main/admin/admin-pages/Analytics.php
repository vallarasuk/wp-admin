...
settings_fields('siteseo_google_analytics_option_group'); ?>
	...
	<?php
	echo wp_kses(siteseo_feature_title('google-analytics'), ['h1' => true, 'input' => ['type' => true, 'name' => true, 'id' => true, 'class' => true, 'data-*' => true], 'label' => ['for' => true], 'span' => ['id' => true, 'class' => true], 'div' => ['id' => true, 'class' => true]]);
	$current_tab = '';
