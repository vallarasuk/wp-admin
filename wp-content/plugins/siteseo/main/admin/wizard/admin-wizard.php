	...
	public function setup_wizard() {
		...
		$default_steps = [
			'welcome' => [
				...
				'description' => __('Configure site\'s SEO', 'siteseo'),
			...
			'import_settings' => [
				...
				'description' => __('Import Metadata', 'siteseo'),
				'handler' => [$this, 'siteseo_setup_import_settings_save'],
				'sub_steps' => [
					'welcome' => esc_html__('Welcome','siteseo'),
					'import_settings' => esc_html__('Import metadata','siteseo')
			...
			'site'	 => [
				...
				'description' => __('Fill site and social data', 'siteseo'),
			...
			'indexing_post_types'	=> [
				...
				'description' => __('Select post type indexing', 'siteseo'),
			...
			'advanced'	=> [
				...
				'description' => __('URL configurations', 'siteseo'),
			...
			'universal'	=> [
				...
				'description' => __('Enable Univeral SiteSEO', 'siteseo'),
		...
		/*elseif ((! is_multisite()) || ! is_plugin_active('siteseo-pro/siteseo-pro.php')){
			...
			if ( ! is_plugin_active('siteseo-pro/siteseo-pro.php')) {
				$default_steps['pro'] = [
					...
					'description' => __('Upgrade to Pro!', 'siteseo'),
					'handler' => '',
					'sub_steps' => $sub_steps,
					'parent' => 'pro'
				];
		...
		$default_steps['ready']  = [
				...
				'description' => __('Its all set now', 'siteseo'),
				'handler' => '',
				'sub_steps' => [
...
<?php
	...
	public function setup_wizard_steps() {
		...
		$parent = $this->parent; ?>
<div id="wpcontent" class="siteseo-setup-wizard-wrapper">
	<div class="siteseo-steps-list-wrap">
		<div class="siteseo-steps-logo-wrap">
			<a href="<?php echo esc_url(admin_url('admin.php?page=siteseo'));?>">
				<img src="<?php echo esc_attr(SITESEO_DIR_URL .'/assets/img/siteseo-white.png');?>" height="50px"/>
			</a>
			<a href="<?php echo esc_url(admin_url());?>" title="WordPress Dashboard"><span class="dashicons dashicons-dashboard siteseo-step-dashboard-icon"></span></a>
		</div>
		<ol class="siteseo-setup-steps">
			...
			<li class="active">
				...
				<div class="siteseo-step-info">
				<span><?php echo esc_html($step['name']); ?></span>
				<span class="siteseo-step-short-description"><?php echo esc_html($step['description']);?></span>
				</div>
			</li>
			<?php
				} elseif ($is_completed) {
			...
			<li class="done">
				<div class="icon" data-step="<?php echo esc_attr($i); ?>"></div>
				<div class="siteseo-step-info">
				<a href="<?php echo esc_url(add_query_arg(['step' => $step_key, 'parent' => $parent])); ?>"><?php echo esc_html($step['name']); ?>
				</a>
				<span class="siteseo-step-short-description"><?php echo esc_html($step['description']);?></span>
				</div>
			</li>
